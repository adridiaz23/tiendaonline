                ...
                if(isset($_POST['isbn'])){//Validaos que tengamos un formulario rellenado
                    ...
                    if($producto->validar($_POST['isbn'])){//validamos que no este el libro ya creado
                        ...
                        if (!((strpos($tipo, "jpeg") || strpos($tipo, "jpg") || strpos($tipo, "png")) && ($tamano < 2000000))) {
                            ...
                            //Se intenta subir al servidor C:\xampp\htdocs\tiendaonline\views\producto\fotos
                            if (move_uploaded_file($temp, "views/producto/fotos/foto_".$_POST['isbn'].".jpg")) {
                                $producto->setImagen("views/producto/fotos/foto_".$_POST['isbn'].".jpg");
                                $producto->insertar();
