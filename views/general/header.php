<body>
    <div class="menu">
        ...
        ?>
        <div class="menu6"> <a href='index.php?controller=Categoria&action=categoriaCliente&idCategoria=<?php echo $categoria[0]->idCategoria ?>'> <?php echo  $categorias[0]->nombre; ?></a></div>
